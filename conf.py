...
BLOG_AUTHOR = "ㄗㄠˋ ㄑㄧˊ"  # (translatable)
BLOG_TITLE = "ㄗㄠˋ ㄑㄧˊ's inner universe"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://nothing.nothing/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://nothing.nothing/"
BLOG_EMAIL = "tsao-chi@the-lingo.org"
BLOG_DESCRIPTION = "This is ㄗㄠˋ ㄑㄧˊ's inner universe"  # (translatable)
